...
function innerDeleteFunction(nameOfBlock){
  ...
  let promise= new Promise((resolve)=>{
    ...
    if(GlobalStorage.toDelete&&GlobalStorage.toDelete.setEffectName&&GlobalStorage.historyOfObjects[nameOfBlock]){//Remove EffectBlock
      effectName=GlobalStorage.toDelete.setEffectName;
      ...
      //Call to ExtScript
                  csInterface.evalScript(`$._ext.deleteEffect("${effectName}")`,(res)=>{//Remove effects from After Effects
                    ...
                    remove=GlobalStorage.toDelete.remove()
                    resolve(remove);
                  });
      //
        ...
        CommonContrlName= GlobalStorage.toDelete.fullCommonContrlName;
        thisCommonContrlName=GlobalStorage.toDelete.thisCommonContrlName;
        itemsArray=GlobalStorage.toDelete.items;
